...
class Game(tk.Tk):
    ...
    def print2(self, row, column, x1, y1, x2, y2):
        ...
        self.canvas.create_text((x1 + x2)/2, (y1+y2)/2, font=("Arial", 36), fill="black", text="2")
    def print4(self, row, column, x1, y1, x2, y2):
        ...
        self.canvas.create_text((x1 + x2)/2, (y1+y2)/2, font=("Arial", 36), fill="import tkinter as tk")
import random
import time
...
class Game(tk.Tk):
    ...
    def print4(self, row, column, x1, y1, x2, y2):
        self.square[row,column] = self.canvas.create_rectangle(x1,y1,x2,y2, fill="#b8dbe5", tags="rect", outline="")
        self.canvas.create_text((x1 + x2)/2, (y1+y2)/2, font=("Arial", 36), fill="black", text="4")
    def print8(self, row, column, x1, y1, x2, y2):
        ...
        self.canvas.create_text((x1 + x2)/2, (y1+y2)/2, font=("Arial", 36), fill="black", text="8")
    def print16(self, row, column, x1, y1, x2, y2):
        ...
        self.canvas.create_text((x1 + x2)/2, (y1+y2)/2, font=("Arial", 36), fill="black", text="16")
    def print32(self, row, column, x1, y1, x2, y2):
        ...
        self.canvas.create_text((x1 + x2)/2, (y1+y2)/2, font=("Arial", 36), fill="black", text="32")
